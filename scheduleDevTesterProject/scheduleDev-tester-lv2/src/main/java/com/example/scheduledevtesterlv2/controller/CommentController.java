...
import com.example.scheduledevtesterlv2.dto.CommentRequestDto; // 댓글 생성 요청 DTO
import com.example.scheduledevtesterlv2.dto.CommentResponseDto; // 댓글 응답 DTO
import com.example.scheduledevtesterlv2.entity.Comment; // 댓글 엔티티
import com.example.scheduledevtesterlv2.entity.Schedule; // 일정 엔티티
import com.example.scheduledevtesterlv2.entity.User; // 사용자 엔티티
import com.example.scheduledevtesterlv2.repository.CommentRepository; // 댓글 리포지토리
import com.example.scheduledevtesterlv2.repository.UserRepository; // 사용자 리포지토리
import com.example.scheduledevtesterlv2.service.CommentService; // 댓글 서비스
import com.example.scheduledevtesterlv2.repository.ScheduleRepository; // 일정 리포지토리
